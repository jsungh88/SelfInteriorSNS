...
Java_com_example_joanne_selfinsns_1_OpenCVActivity_ConvertRGBtoGray(JNIEnv *env,
                                                                    jobject instance,
                                                                    jlong matAddrInput,
                                                                    jlong matAddrResult) {
...
JNIEXPORT void JNICALL
Java_com_example_joanne_selfinsns_1_OpenCVImageFilterActivity_loadImage(
        JNIEnv *env,
        jobject instance,
...
JNIEXPORT void JNICALL
Java_com_example_joanne_selfinsns_1_OpenCVImageFilterActivity_imageprocessing(
        JNIEnv *env,
        jobject instance,
...
Java_com_example_joanne_selfinsns_1_OpenCVActivity_loadCascade(JNIEnv *env, jobject instance,
...
Java_com_example_joanne_selfinsns_1_OpenCVActivity_detect(JNIEnv *env, jobject instance,
