...
public class StyleBookAdapter_mypage extends RecyclerView.Adapter<StyleBookAdapter_mypage.ViewHolder> {
    ...
    public StyleBookAdapter_mypage(StyleBook context, List<StyleBookItem> items) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.stylebook_item2, parent, false);
