...
import com.example.joanne.selfinsns_.ProfileEditActivity;
import com.example.joanne.selfinsns_.R;
import com.example.joanne.selfinsns_.utils.BitmapUtils;
import com.example.joanne.selfinsns_.utils.SpacesItemDecoration;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
//                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), ProfileEditActivity.IMAGE_NAME, 100, 100);
//                    thumbImage = BitmapUtils.getBitmapFromGallery(this,uriImage,300,300);
                    thumbImage = bitmap;
                } else {
